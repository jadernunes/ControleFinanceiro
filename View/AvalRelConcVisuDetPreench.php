...
if(count($result) > 0)
{
    ...
    ?>
    <tr>
        <td><textarea name='correcao' id='correcao' style="width: 500px;height: 100px;resize: none;" ><?php echo $valor['descricao']?></textarea></td>
    </tr>
    <?php
    }
}
else
{
    ?>
    <tr>
        <td><textarea name='correcao' id='correcao' style="width: 500px;height: 100px;resize: none;" ></textarea></td>
    </tr>
    <?php
    }
?>
...
<tr>
    <td align='center'>
        <table   style="width: 280px;">
            <tr>
                <td align='center'><input id='btCorrigirRelat'  name="btCorrigirRelat" type='submit' value='Corrigir Relatório'/></td>
                <td align='center'><input id='btConfRelat'  name="btConfRelat" type='submit' value='Confirmar Relatório'/></td>
            </tr>
        </table>
    </td>
</tr>
