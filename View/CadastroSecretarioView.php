...
$result = $classGeral->select('Select * from usuario u where u.idTipoUsuario = 3 and ativo = 1');
...
<html>
    ...
    <body>
        <table  align="center" style=" background-color: darkgray;width: 100%;border: none;">
            <tr>
                <td  align="left">
                    <table  align="center" style=" background-color: darkgray;width: 100%;border: none;">
                        <tr>
                            <td  align="left">Cadastro de Secretário</td>
                        </tr>
                    </table>
                </td>
                <td>
        ...
        <form action="../Persistence/formCadastroSecretario.php" method="post">
            ...
            <table cellpadding=0 cellspacing=0 align="center" style="border-bottom: none;border-left: none;border-right: none;">
                <tr><td align="center">Secretários</td></tr>
                <tr>
                    <td align="center">
