...
<html>
    ...
    <body style="padding: 0;margin: 0;">
        <table  align="center" style=" background-color: darkgray;width: 100%;border: none;">
            <tr>
                <td  align="left">
                    <table  align="center" style=" background-color: darkgray;width: 100%;border: none;">
                        <tr>
                            <td  align="left">Relatórios Concluidos/Confirmados</td>
                        </tr>
                    </table>
                </td>
                <td>
        ...
        <form action="../Persistence/formImpRelatConcConf.php" name="form" method="post" >
            <table cellpadding=0 cellspacing=0 align="center" style="border-bottom: none;border-left: none;border-right: none;">
                ...
                <tr><td align="center">Selecione uma turma</td></tr>
                 <tr>
                     <td align="center">
                         <select id="idTurma" name="idTurma" style="width: 200px;" onchange="loadDiv('RelConcDesc.php?idTurma='+$(this).val(),'div_dados')" >
