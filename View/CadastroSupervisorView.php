...
$result = $classGeral->select('Select * from usuario u where u.idTipoUsuario = 5 and ativo = 1');
...
<html>
    ...
    <body style="padding: 0;margin: 0;">
        ...
        <form action="../Persistence/formCadastroSupervisor.php" method="post">
                        ...
                        <table  cellpadding=0 cellspacing=0 align="center" style="border-style: groove;width: 100%;">
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td align="center" style="border-style: ridge;border-bottom: none;border-left: none;border-right: none;"><label>&nbsp;&nbsp;<?php echo $valor['nome'];?>&nbsp;&nbsp;</label></td>
