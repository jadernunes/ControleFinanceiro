...
//select Turmas onde tiver o idProfessor
$onload = "";

if(isset($_GET['idTurma']) && isset($_GET['idGrupo'])){
    $onload = "onload=loadDiv('descricaoCampoGrupo.php?idGrupo=".$_GET['idGrupo']."&idTurma=".$_GET['idTurma']."','div_dados');";
}
...
<html >
    ...
    <body <?php echo $onload;?>>
        <table  align="center" style=" background-color: darkgray;width: 100%;border: none;">
            <tr>
                <td  align="left">
                    <table  align="center" style=" background-color: darkgray;width: 100%;border: none;">
                        <tr>
                            <td  align="left">Cadastro de Objetivos</td>
                        </tr>
                    </table>
                </td>
                <td>
        ...
        <form action="../Persistence/formCadastroObjetivos.php" name="form" method="post" >
            <table cellpadding=0 cellspacing=0 align="center" style="border-bottom: none;border-left: none;border-right: none;">
               ...
               <tr><td align="center">Selecione uma turma</td></tr>
                <tr>
                    <td align="center">
                        <select id="idTurma" name="idTurma" style="width: 200px;" onchange="loadDiv('descricaoCampoGrupo.php?idTurma='+$(this).val(),'div_dados')" >
