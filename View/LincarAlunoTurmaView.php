...
<html>
    ...
    <body>
            ...
            <tr>
                <td  align="left">
                    <table align="center" style=" background-color: darkgray;width: 100%;border: none;border-bottom: none;border-left: none;border-right: none;">
                        <tr>
                            <td  align="left">Lincar Alunos em Turma</td>
                        </tr>
                    </table>
                </td>
                <td>
        ...
        <form action="../Persistence/formLincar.php" name="form" method="post">
            <table cellpadding=0 cellspacing=0 align="center" style="border-bottom: none;border-left: none;border-right: none;">
                <input type="hidden" id="typeLinck" name="typeLinck" value="alunoTurma"/>
                            ...
                            <tr>
                                ...
                                <td  >
                                    <table cellpadding=0 cellspacing=0  style="border-style: solid;border-width: 1px;width: 100%">
                                        ...
                                        $resultP = $classGeral->select('select * From Usuario u inner join UsuarioTurma ut on u.idUsuario = ut.idUsuario where u.idTipoUsuario = 2 and ut.idTurma = '.$valorT['idTurma']);
