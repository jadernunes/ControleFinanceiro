...
//                     echo $sq;
                 ...
                 <select id="idGrupo" name="idGrupo" style="width: 200px;text-align: center;" onchange="loadDiv('CorrigirRelVisu.php?idTurma=<?php echo $idTurma;?>&idGrupo='+$(this).val(),'detalhePreencRelatorioConc'); if($(this).val() > 0){setVisible('btConfirmarGrupo',true);}else{setVisible('btConfirmarGrupo',false);}" >
