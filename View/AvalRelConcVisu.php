    ...
    <table cellpadding=0 cellspacing=0 align="center" style="border-bottom: none;border-left: none;border-right: none;">
        <tr><td align="center">Selecione um Relatório Concluído</td></tr>
         <tr>
             <td align="center">
                 <?php
                 $sq = 'Select * From Relatorio r where idTurma = '.$idTurma.' and identificadorGrupo = '.$idGrupo.' and statusResposta = 3';
//                     echo $sq.'<br/>';
                 ?>
                 
                 <select id="idRelatorio" name="idRelatorio" style="width: 200px;text-align: center;" onchange="loadDiv('AvalRelConcVisuDetPreench.php?idGrupo=<?php echo $idGrupo;?>&idTurma=<?php echo $idTurma;?>&idRelatorio='+$(this).val(),'detalheMostraRelatorio');//this.disabled = true;" >
