...
//                     echo $sq;
                 ...
                 <select id="idGrupo" name="idGrupo" style="width: 200px;text-align: center;" onchange="loadDiv('RelPreVisu.php?idTurma=<?php echo $idTurma;?>&idGrupo='+$(this).val(),'detalhePreencRelatorio'); if($(this).val() > 0){setVisible('btConcluirGrupo',true);}else{setVisible('btConcluirGrupo',false);}" >
         ...
         <tr>
             <td align='center'><input style="display: none;" id='btConcluirGrupo'  name="btConcluirGrupo" type='submit' value='Concluir Relatórios do Grupo'/></td>
        </tr>
        <tr>
             <td>&nbsp;</td>
         </tr>
