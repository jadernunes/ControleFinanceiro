                                ...
                                <tr>
                                    <td align="center" style="width: 70%;">
                                        <table style="width: 100%;">
                                            ...
                                            <tr>
                                                <td align='center' style="width: 70%;">
                                                    <input style="text-align: center;" id="nome" name="nome" value="<?php echo $_SESSION['user']['nome']?>"/>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align='center' style="width: 70%;">
                                            ...
                                            <tr>
                                                <td align='center' style="width: 70%;">
                                                    <input style="width:50%;text-align: center;" id="email" name="email" value="<?php echo $_SESSION['user']['email']?>"/>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align='center' style="width: 70%;">
                                            ...
                                            <tr>
                                                <td align='center' style="width: 70%;">
                                                    <input style="text-align: center;" type="password" id="confPassword" name="confPassword"/>
                                                </td>
                                            </tr>
