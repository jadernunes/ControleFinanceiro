    ...
    <table cellpadding=0 cellspacing=0 align="center" style="border-bottom: none;border-left: none;border-right: none;">
        <tr><td align="center">Selecione um Relatório</td></tr>
         <tr>
             <td align="center">
                 <?php
                 $sq = 'Select * From Relatorio r where idUsuarioProfessor = '.$idUserProfessor.' and idTurma = '.$idTurma.' and identificadorGrupo = '.$idGrupo.' and (statusResposta = 2 or statusResposta = 1)';
//                     echo $sq.'<br/>';
                 ?>
