...
if(isset($_POST['btCancelar'])){
    $classGeral->loadPagina('../View/PreencherRelatorioView.php?idTurma='.$idTurma.'&idGrupo='.$idGrupo.'&idRelatorio='.$idRelatorio);
}else{
    ...
    if($totalObjetivosBanco == $totalObjetivosRecebidos){
        ...
        $classGeral->loadPagina('../View/PreencherRelatorioView.php?idTurma='.$idTurma.'&idGrupo='.$idGrupo);
    }else{
